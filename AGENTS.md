...
- Ground every displayed Resume quote after whitespace normalization. Remove unsupported quotes and downgrade DIRECT/PARTIAL with no valid quote to GAP. Requirements must come from the current JD Analysis; totals are deterministic counts, never scores.
