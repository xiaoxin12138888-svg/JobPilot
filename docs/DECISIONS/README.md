...
- [ADR-012：牛客当前岗位采集与共享采集合同](ADR-012-nowcoder-shared-capture-contract.md) — Accepted
...
- [ADR-017：本地 PDF / DOCX 简历导入](ADR-017-local-resume-import.md) — Accepted
- [ADR-018：基于本地求职上下文的可选 AI Copilot](ADR-018-ai-job-copilot.md) — Accepted
